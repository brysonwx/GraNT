...
def main():
    ...
    if not args.filename == '':
        res_data = {'Total_time': end_time - start_time, 'Val': valid_curve[best_val_epoch], 'Test': test_curve[best_val_epoch], 'Train': train_curve[best_val_epoch], 'BestTrain': best_train}
        with open(args.filename, 'w') as f:
            json.dump(res_data, f)
        # torch.save({'Total_time': end_time - start_time, 'Val': valid_curve[best_val_epoch], 'Test': test_curve[best_val_epoch], 'Train': train_curve[best_val_epoch], 'BestTrain': best_train}, args.filename)
